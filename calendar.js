 ...
 */
 const calendar = {
    ...
    /**
     *
     * @param param {Object} 按照festival的格式輸入數據，設置陽歷節日
     */
    setFestival(param = {}) {
        this.festival = param
    },
    ...
    /**
     *
     * @param param {Object} 按照lFestival的格式輸入數據，設置農歷節日
     */
    ...
    toGanZhiYear: function (lYear) {
        ...
        if (ganKey === 0) ganKey = 10;//如果餘數為0則為最後一個天乾
     ...
     * !important! 公歷參數區間1900.1.31~2100.12.31
    ...
    solar2lunar: function (yPara, mPara, dPara) {
        ...
        for (i = 1; i < 13 && offset > 0; i++) {
            ...
            if (leap > 0 && i === (leap + 1) && isLeap === false) {
                --i;
                isLeap = true;
                temp = this.leapDays(year); //計算農歷閏月天數
            } else {
        ...
        // 農歷節日修正：農歷12月小月則29號除夕，大月則30號除夕
        // 此處取巧修正：當前為農歷12月29號時增加一次判斷並且把lunarFestivalDate設置為12-30以正確取得除夕
        // 天朝農歷節日遇閏月過前不過後的原則，此處取農歷12月天數不考慮閏月
        // 農歷潤12月在本工具支持的200年區間內僅1574年出現
